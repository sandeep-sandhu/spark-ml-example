...
object ExploratoryAnalysis{
  ...
  def exploreDF(inputDF: Dataset[ModelDataRecord],
    ...
    logger.info("Showing the target distribution for all the categorical variables:")
    ...
    logger.info("Showing the numerical variables distribution for each value of the target:")
   ...
   */
  private def numericalBivariateTable(inputData: Dataset[_],
                                      labelColName: String,
                                      colToAnalyse: String,
                                      label1: String,
                                      label2: String): DataFrame = {
